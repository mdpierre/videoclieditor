---
name: "rewrite-edit-video"
description: "Use this as the one-stop agent editing workflow for a raw video: transcribe it, talk with the user about the transcript and editorial goals, produce a final-draft transcript, then render the finished cut with rewrite-edit."
---
